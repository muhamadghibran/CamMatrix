  ...
  return (
    <div>
      ...
      <div
        ...
        style={{
          border: `1px solid ${focused ? "rgba(255,255,255,0.5)" : "rgba(255,255,255,0.08)"}`,
          background: "rgba(255,255,255,0.04)",
          boxShadow: focused
            ? "0 0 0 3px rgba(255,255,255,0.08), 0 0 20px rgba(255,255,255,0.06)"
            : "none",
      ...
      >
        <FieldIcon
          ...
          style={{
            color: focused ? "#FFFFFF" : "rgba(148,163,184,0.6)",
            transition: "color 0.2s",
          }}
        />
        <input
    ...
    >
      ...
      <div
        style={{
          ...
          boxShadow:
            "0 32px 80px rgba(0,0,0,0.9), 0 0 0 1px rgba(255,255,255,0.06), 0 0 60px rgba(255,255,255,0.06)",
          /* Entrance animation */
          opacity: visible ? 1 : 0,
          transform: visible
      ...
      >
        ...
        >
          <div style={{ display: "flex", alignItems: "center", gap: "14px" }}>
            ...
            >
              <Tv2 size={16} style={{ color: "#FFFFFF" }} />
            </div>
            <div
