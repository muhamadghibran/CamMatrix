  ...
  return (
    <div
      ...
      style={{
        ...
        boxShadow: "0 8px 32px rgba(0,0,0,0.3), 0 0 20px rgba(16,185,129,0.1)",
      }}
    >
      <div
...
export default function RecordingsPage() {
  ...
  const filtered = useMemo(
    () =>
      allRecordings.filter((r) => {
        ...
        const matchCamera =
          filterCamera === "Semua" || r.camera === filterCamera;
  ...
  return (
    <div className="space-y-6 relative z-10 w-full">
      {downloadToast && (
        <DownloadToast
          filename={downloadToast}
          onClose={() => setDownloadToast(null)}
        />
      )}
      <div className="flex bg-(--color-surface) p-1.5 rounded-xl w-max border border-(--color-card-border)  ">
        <button
      ...
      {activeTab === "analytics" ? (
        ...
        <>
          <div className="grid grid-cols-3 gap-5">
            {statsList.map(
              ({ icon: Icon, labelKey, value, subKey, color }, i) => (
                <div
                  key={labelKey}
                  className="gradient-border noise   cursor-pointer group relative overflow-hidden"
                  style={{
                    backgroundColor: "var(--color-surface)",
                    padding: "20px",
                  ...
                  onMouseEnter={(e) => {
                    ...
                    e.currentTarget.style.boxShadow = `0 14px 36px rgba(0,0,0,0.12), 0 0 0 1px ${color}35`;
                  }}
                  onMouseLeave={(e) => {
                ...
                >
                  <div
                    ...
                    style={{
                      background: `radial-gradient(ellipse at 0% 0%, ${color}14, transparent 55%)`,
                  ...
                  <div
                    className="stat-number text-3xl font-bold mb-1 relative z-10"
                    style={{ color }}
                  >
                    <AnimatedText
                      text={value}
                      delayOffset={200 + i * 100}
                      splitBy="char"
                    />
                  </div>
                  <p
          ...
          <div className="flex items-center gap-3    flex-wrap">
            ...
            <div className="relative">
              ...
              {showFilter && (
                <div
                  className="absolute top-12 left-0 z-20 w-48 rounded-xl shadow-xl overflow-hidden "
                  style={{
                    backgroundColor: "var(--color-surface)",
                    border: "1px solid var(--color-card-border)",
                  }}
