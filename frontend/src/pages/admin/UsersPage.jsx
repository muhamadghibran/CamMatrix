      ...
      >
          ...
          {[
            {
              ...
              key: "full_name",
              placeholder: t("users.modal.namePH"),
              type: "text",
            },
            {
              label: t("users.modal.email"),
              key: "email",
              placeholder: t("users.modal.emailPH"),
              type: "email",
            },
            ...(!isEdit
              ? [
                  {
                    ...
                    key: "password",
                    placeholder: t("users.modal.passPH"),
                    type: "password",
                  },
                ]
              : []),
        ...
        <div className="flex gap-3 px-6 pb-6">
          ...
          <button
            ...
            style={{
              background: "linear-gradient(135deg,#8b5cf6,#00ffff)",
              boxShadow: "0 4px 14px rgba(0,255,255,0.4)",
...
export default function UsersPage() {
  ...
  return (
    <div className="space-y-6 relative z-10 w-full">
      ...
      {deleteTarget && (
        <ConfirmModal
          message={`Yakin ingin menghapus "${deleteTarget.full_name}"?`}
                  ...
                  >
                    ...
                    <td className="px-5 py-4">
                      <span className="flex items-center gap-2">
                        <span
                          className={`w-2 h-2 rounded-full ${u.is_active !== false ? "animate-blink" : ""}`}
                          style={{
                            backgroundColor:
                              u.is_active !== false ? "#10b981" : "#6b7280",
                            boxShadow:
                              u.is_active !== false
