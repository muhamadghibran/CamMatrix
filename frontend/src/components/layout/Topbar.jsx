    ...
    >
      <div
        ...
        style={{
          ...
          boxShadow: isDark
            ? "0 32px 80px rgba(0,0,0,0.8), 0 0 0 1px rgba(6,182,212,0.1)"
    ...
    <>
      ...
      >
        <div
          ...
          style={{
            background: isDark
              ? "linear-gradient(90deg, transparent 0%, rgba(6,182,212,0.25) 30%, rgba(56,189,248,0.2) 70%, transparent 100%)"
